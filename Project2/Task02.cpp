...
bool antisymmetric_matrix(int matrix[size][size], int entered_size);
...
int main() {
	...
	string result = antisymmetric_matrix(matrix, entered_size)
		? "Yes, there is antisymmetric matrix" : "No, there isn't antisymmetric matrix";
